...
public class SupplyUpdateDTO {
    ...
    @Size(min = 1, max = 100, message = "Supply name max size in 100")
    private String name;
    
    @Size(min = 1, max = 255, message = "Supply specification max size in 255")
    private String specification;

    @Size(min = 1, max = 150, message = "Supply provider name max size in 150")
